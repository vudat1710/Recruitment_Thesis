...
ADDRESS_DICT_PATH = "get_data/template/address.json"
MAJOR_DICT_PATH = "get_data/template/major.json"
MEDIATED_SCHEMA_PATH = "./template/mediated_schema.json"
STOPWORDS_PATH = "./template/vietnamese-stopwords-dash.txt"
SAMPLE_PATH = "./sample/"
DATA_PATH = "./data/"
MODEL_PATH = "./model/"